		   ...
		   <div class="content">
		    <div class="container-fluid">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
									...
									<li class="breadcrumb-item"><a href="hesabim.php">Anasayfa</a></li>
                                        <li class="breadcrumb-item active">Market Alışveriş Geçmişi</li>
                                    </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
           <div class="card-body">
                                        <h4 class="mt-0 header-title mb-5">Market Alışveriş Geçmişi</h4>
		  ...
		  <?php } ?>
            ...
            <script type="text/javascript">
                ...
                function switchPage(page) {
                    ...
                    $('#ticket-content').load("fonks.php?pagelogm=" + page,function (response, status, xhr) {
                        if (status != "success") {
                            swal({
                                title: 'Opps...',
                                text: xhr.statusText,
