    ...
    <div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Yardım Konusu Ekle</h3>
            </div>
            <form class="form-horizontal" method="post" id="faqs-create">
               <input type="hidden" name="faqsekle">
