...
for($i=($Page-2); $i<=($Page+2); $i++)	{
	...
	echo'<li class="disabled"><a>&laquo;</a></li>';
		...
		echo'<li><a onclick="switchPage(1);">&laquo;</a></li>';
		
		}
	
		if(($Page-3)>0) {
				if($_GET["pagekarakter"] == 1)
					echo '<li ><a onclick="switchPage('.$x.');">'.$x.'</a></li>';
				else				
					echo '<li ><a onclick="switchPage('.$x.');">'.$x.'</a></li>';
			}
		...
		for($i=($Page-2); $i<=($Page+2); $i++)	{
			...
			if($Page == $i) { 
		     ...
		     $active = "";
				...
				if($Page == $i)
					echo '<li class='.$active.'><a onclick="switchPage('.$i.');">'.$i.'</a></li>';
				else				
					echo '<li class='.$active.'><a onclick="switchPage('.$i.');">'.$i.'</a></li>';
			}
...
echo'<li><a onclick="switchPage('.$Next.');">&raquo;</a></li>';	
	}
		}
	}
