...
<div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Banka Hesapları <small></small></h3>
<script src="plugins/sweetalert/sweetalert.min.js"></script>
   ...
   <table id="myTable" class="table table-responsive">
		...
		<?php  foreach($degerler as $row){?>
                    ...
                    <tr>
                <td><?php echo $rank++; ?></td>
                <td title="<?php echo $row['bankaAdi']; ?>">
                    <?php echo $row['bankaAdi']; ?>
                </td>
    ...
    <div class="col-lg-8">
        <div class="pull-right" style="padding: 20px 0">
            <a class="btn btn-sm btn-primary btn-flat"
               href="?do=hesapno_ekle">
                <i class="fa fa-check"></i> Hesap No Ekle
            </a>
