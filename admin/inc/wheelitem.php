    ...
    <div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Item Ödülü Ekle</h3>
            </div>
            <form class="form-horizontal" method="post" id="reward-create">
			<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                <input type="hidden" name="wheelitem">
                ...
                <div class="box-body">
                    <div class="form-group" id="group-code_name">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="code_name" placeholder="ITEM_">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="group-optlevel">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="optlevel" value="0">
                        </div>
                    </div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="callout callout-info">
                    <ul>
                        <li>Item Kodu alanına _RefObjCommon tablosunda yer alan itemin CodeName'ini yazmalısınız. Yanlış
                            yazdığınız taktirde ödül verme işlemi gerçekleşmeyecektir.
                        </li>
                        <li>Item Resmi alanına resmin linkini yazmalısınız.</li>
