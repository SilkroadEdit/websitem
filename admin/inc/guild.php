    ...
    <div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Guild Ara & Düzenle <small></small></h3>

                <div class="box-tools">
                    <div id="searchForm" class="input-group input-group-sm" style="width: 200px;">
                        <input type="text" class="form-control pull-right" id="searchInput" placeholder="Guild Adı">
		 ...
		 <?php $pgn->Pagination($getfonk, $toplam_sayfa);?>
            ...
            <script type="text/javascript">
                ...
                function doAjaxSearch() {
                    ...
                    overOverLayer();
                    saveRequest = sValue + '/';
                    $('#search-content').load("faqs.php?name4=" + sValue, function (response, status, xhr) {
                        if (status != "success") {
                            swal({
                                title: 'Opps...',
                                text: xhr.statusText,
                ...
                function switchPage(page) {
                    overOverLayer();
                    $('#search-content').load("faqs.php?pageguild=" + page,function (response, status, xhr) {
                        if (status != "success") {
                            swal({
                                title: 'Opps...',
                                text: xhr.statusText,
