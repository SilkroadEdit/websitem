...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Karaktere TL Ver</h3>
            </div>
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'TL karaktere başarıyla eklendi.', 'success');
					 setTimeout("window.location = 'admin.php?do=tl2';", 2000);
                    ...
                    <div class="form-group" id="group-amount">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control"  name="miktar">
								...
								<input type="hidden" name="add_tl2">
