...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Karaktere SP Ver</h3>
            </div>
	...
	function itemver(){
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'Sp karaktere başarıyla eklendi.', 'success');
					 setTimeout("window.location = 'admin.php?do=sp';", 2000);
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-amount">
                        <label for="amount" class="col-sm-3 control-label">Sp Miktarı</label>
