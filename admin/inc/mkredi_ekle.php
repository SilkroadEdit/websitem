    ...
    <div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Markete Kredi Ekle</h3>
            </div>
            <form class="form-horizontal" method="post" id="market-create">
                <input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">

                <input type="hidden" name="add_mkredi">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group" id="group-total">
                        <label for="total" class="col-sm-3 control-label">Kredi Miktarı</label>
                    ...
                    <div class="form-group" id="group-price">
                        <label for="price" class="col-sm-3 control-label">Kredi Fiyatı</label>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="callout callout-info">
                    <ul>
                        <li>Ürün Adı kısmına örneğin, (100 Kredi) gibi isim yazmalısınız.</li>
                        <li>Ürün Resmi alanına resmin linkini yazmalısınız.</li>
                        <li>Fiyat Tipi alanında Kredi'nin TL veya Silk ile mi satılacağını seçmelisiniz.</li>
                        <li>Ürün Fiyatı alanında Kredi'nin TL veya Silk fiyatını yazmalısınız.</li>
