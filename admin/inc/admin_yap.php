...
<script>
	function itemver(){
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'Kullanıcıya başarılı şekilde panel admin yetkisi verildi.', 'success');
					 setTimeout("window.location = 'admin.php?do=adminlistesi';", 2000);
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-amount">
                        <label for="amount" class="col-sm-3 control-label">IP Adresi</label>
 ...
 <p>Panele girişte IP Kısıtlaması istemiyorsanız IP Adresini boş bırakabilirsiniz.</p>
                </div>
            </div>
        </div>    </div>      
