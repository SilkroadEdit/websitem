...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Markete Silk Ekle</h3>
            </div>
	...
	function itemver(){
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-total">
                        <label for="total" class="col-sm-3 control-label">Silk Miktarı</label>
                    ...
                    <div class="form-group" id="group-price">
                        <label for="price" class="col-sm-3 control-label">Satış Fiyatı</label>

                        <div class="col-sm-8">
                            <input type="text" class="form-control" maxlength="9" name="tl">
                        </div>
                    </div>
...
<input type="hidden" name="add_msilk" >
				<footer>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="callout callout-info">
                    <ul>
                        <li>Ürün Adı kısmına örneğin, (100+50 Silk) gibi isim yazmalısınız.</li>
                        <li>Ürün Resmi alanına resmin linkini yazmalısınız.</li>
						<li>Fiyat Tipi alanında itemin TL veya Silk ile mi satılacağını seçmelisiniz.</li>
                        <li>Ürün Sırası alanına rakam olarak ürünün gözükeceği sırayı yazmalısınız.</li>
                        <li>Item Fiyatı alanında silk'in TL veya Silk fiyatını yazmalısınız.</li>	
                    </ul>
                </div>
            </div>
        </div>
