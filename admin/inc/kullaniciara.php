    ...
    <div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Kullanıcı Adı İle Tüm Bilgileri Bul</h3>
            ...
            <form class="form-horizontal" method="post" id="info-username">
                ...
                <div class="box-body">
                    <div class="form-group" id="group-username">
					 ...
					 <input type="hidden" name="kullanıcı" id="kullanıcı">
                </div>
                <div class="box-footer">
                    <button type="reset" class="btn btn-default" onclick="window.location.replace('/admin')">Vazgeç</button>
