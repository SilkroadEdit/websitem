...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Kullanıcıya Silk Ver</h3>
            </div>
	...
	function itemver(){
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'Silk kullanıcıya başarıyla eklendi.', 'success');
					 setTimeout("window.location = 'admin.php?do=silk_ekle';", 2000);
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-amount">
                        <label for="amount" class="col-sm-3 control-label">Silk Miktarı</label>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control"  name="miktar">
								...
								<input type="hidden" name="add_silk">
