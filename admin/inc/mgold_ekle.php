...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Markete Gold Ekle</h3>
            </div>
	...
	function itemver(){
     ...
     <div class="box-body">
                    ...
                    <div class="form-group" id="group-total">
                        <label for="total" class="col-sm-3 control-label">Gold Miktarı</label>
...
<input type="hidden" name="add_mgold">
				<footer>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="callout callout-info">
                    <ul>
					               <li>Ürün Adı kısmına örneğin, (1B Gold) gibi isim yazmalısınız.</li>
                        ...
                        <li>Fiyat Tipi alanında gold'un TL veya Silk ile mi satılacağını seçmelisiniz.</li>
                        <li>Item Fiyatı alanında gold'un TL veya Silk fiyatını yazmalısınız.</li>
