...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">GameMaster Yetkisi Ver</h3>
            </div>
	...
	function itemver(){
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'Kullanıcıya başarılı şekilde gamemaster yetkisi verildi.', 'success');
					 setTimeout("window.location = 'admin.php?do=gmlistesi';", 2000);
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-amount">
                        <label for="amount" class="col-sm-3 control-label">Yetki ID</label>
            ...
            <div class="box-body">
                <div class="alert alert-danger alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <p>Kullanıcı Adı kısmına GM yapmak istediğiniz kullanıcının adını yazmalısınız.</p>
                        <p>Yetki ID kısmına User tablosunda kullanılan sec_primary'i yazmalısınız. <br>Orjinalde; GM = 1, Normal Kullanıcı = 3'tür.</p>
