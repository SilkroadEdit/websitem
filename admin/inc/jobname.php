...
<div class="content-wrapper">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Job Adı Değiştir</h3>
            </div>
	...
	function itemver(){
		...
		$.ajax({
			...
			success : function(pure){
				...
				appendAlertBox('#itemformu', 'error', 'Lütfen tüm alanları doldurunuz.');
					...
					swal('Başarılı', 'Job adı başarıyla değiştirildi.', 'success');
					 setTimeout("window.location = 'admin.php?do=jobname';", 2000);
				}else if($.trim(pure) == "hata"){
				appendAlertBox('#itemformu', 'error', 'İşlem yapmak istediğiniz Job bulunamadı.');	
				...
				appendAlertBox('#itemformu', 'error', 'Değiştirmek istediğiniz Job adı zaten kullanılır durumda');
		...
		<input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <div class="form-group" id="group-amount">
                        <label for="amount" class="col-sm-3 control-label">Yeni Job Adı</label>
